...
DATA_NAME ='DIV2K_8'
DEMO_NAME = 'Real_16'
TEST_NAME = ['Set5', 'Set14', 'B100', 'Urban100']
...
parser.add_argument('--pre_train', type=str, default='pretrained_models\model_x4.pt',
...
# Log specifications
parser.add_argument('--save', type=str, default='EASR',
